...
<form class="father" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" name="name" class="form-control" id="validationDefault01" placeholder="Course Name" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault02"> Catagory</label>
      <input type="text" name="spec" class="form-control"  placeholder="Course Catagory"  required>
    </div>
  </div>
  <div class="form-row">
      <div class="col-md-4 mb-3">
      ...
      <div class="input-group">
        ...
        <input type="text"  class="form-control"  name="ctime" placeholder="ex..3pm-5pm"  required>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" name="age" placeholder="ex..2-4 years " required>
    </div>
  </div>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="number" name="seat" class="form-control" id="validationDefault04" placeholder="number only" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault05">Price</label>
      <input type="number" name="price" class="form-control" id="validationDefault05" placeholder="Number only" required>
    </div>
  ...
  <div class="col-md-4 mb-3">
      ...
      <input type="number" name="rate" class="form-control" id="validationDefault05" placeholder="Number only" required>
    </div>
    ...
    <div class="col-6">
      ...
      <textarea name="desc" class="form-control" id="validationDefault05"  placeholder="" required>
      </textarea>
    </div>
